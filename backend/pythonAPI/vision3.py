...
# Send data to DeepInfra API for UI generation
...
payload = {
    ...
    "messages": [
        ...
        {"role": "user", "content": f"Generate a user interface design in  HTML+CSS based on the following image analysis: {json.dumps(output_data, indent=4)}"}
    ]
}
